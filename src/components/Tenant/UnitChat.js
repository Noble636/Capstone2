...
import '../../css/Tenant/UnitChat.css';
...
const UnitChat = ({ tenantId }) => {
  ...
  // Fetch all active inquiries for this tenant
  useEffect(() => {
    fetch(`/api/unit-inquiries?tenantId=${tenantId}`)
      .then(res => res.json())
  ...
  return (
    <div className="unit-chat-container">
      <h2>My Unit Inquiries & Chat</h2>
      <div className="unit-chat-main">
        <div className="unit-chat-list">
        ...
        <div className="unit-chat-window">
            ...
            <>
              ...
              <div className="chat-messages">
                {messages.map(msg => (
                  <div
                    key={msg.message_id}
                    className={`chat-message ${msg.sender_type === 'tenant' ? 'tenant' : 'admin'}`}
                  >
                    <div className="msg-meta">
                      {msg.sender_type === 'tenant' ? 'You' : 'Admin'}
